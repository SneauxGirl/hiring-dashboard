...
export const MOCK_DASHBOARD: DashboardData = {
  ...
  funnelStages: [
    { stageKey: 'h1', label: 'Applicants', count: 3675, colorZone: 'early' },
    { stageKey: 'h2', label: 'Screened', count: 3273, conversionPct: 89.06, colorZone: 'early' },
    { stageKey: 'h3', label: 'Assessment', count: 657, conversionPct: 20.07, colorZone: 'early' },
    { stageKey: 'h4', label: 'Interviews', count: 439, conversionPct: 66.82, colorZone: 'late' },
    { stageKey: 'h5', label: 'Offer', count: 71, conversionPct: 16.17, colorZone: 'late' },
    { stageKey: 'h6', label: 'Hired', count: 69, conversionPct: 97.18, colorZone: 'late' },
  ],
  stageDurations: [
